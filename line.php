  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "อยากทราบยอด COVID-19 ครับ")||($text == "ข้อ 1")||($text == "1")){
			$reply_message = 'รายงานสถานการณ์ ยอดผู้ติดเชื้อไวรัสโคโรนา 2019 (COVID-19) ในประเทศไทย ผู้ป่วยสะสม จำนวน 2613 ราย ผู้เสียชีวิตวันนี้จำนวน 1 ราย รักษาหาย จำนวน 1405 ราย ผู้รายงานข้อมูล: นายจิรวัฒน์ บริบรรณ';
		}
